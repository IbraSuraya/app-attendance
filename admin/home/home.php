  ...
  <div class="container-xl">
    <div class="row row-deck row-cards">
      ...
      <div class="col-md-6 col-lg-4">
        <a href="https://www.youtube.com/@ibrasuraya" class="card card-sponsor" target="_blank" rel="noopener" style="background-image: url(<?= base_url("assets/img/payments/info-square-rounded-filled.svg")?>)" aria-label="Sponsor Tabler!">
